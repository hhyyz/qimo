...
public class QiniuUtil {
	...
	private static String accessKey = "1DVvnO7FmQK6VxadIDzoXiDxhcY0HTA308iHlEmD";
	private static String secretKey = "GPpIVQ6gUJxmWHBVAE9tnaqiC63WeYi2zjSFrfwu";
	private static String bucket = "bjyx"; // 七牛空间名（改为自己的）
